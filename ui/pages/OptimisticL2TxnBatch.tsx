...
const OptimisticL2TxnBatch = () => {
  ...
  const tabs: Array<TabItemRegular> = React.useMemo(() => ([
    { id: 'index', title: t('transactions.common.details'), component: <OptimisticL2TxnBatchDetails query={ batchQuery }/> },
    {
      id: 'txs',
  ...
  return (
    <>
      <TextAd mb={ 6 }/>
      <PageTitle
        title={ `${ t('txnBatches.common.batch_number') }${ batchQuery.data?.number }` }
