...
const SettingsLangItem = ({ label, value, bg, onClick, isActive, isLanguage = false }: Props) => {
  ...
  if (isLanguage) {
    ...
    const flagMap: Record<string, string> = {
      ...
      'zh-CN': t('settings.common.flag_china'),
    };
...
export default React.memo(SettingsLangItem);
