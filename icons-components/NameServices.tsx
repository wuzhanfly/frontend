...
export default function NameServices(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
  ...
  <path clipRule="evenodd" d="M22.998 24.393a4.805 4.805 0 1 1 .728-.728l2.457 2.456a.515.515 0 1 1-.728.728l-2.457-2.456Zm.761-3.743a3.776 3.776 0 1 1-7.55 0 3.776 3.776 0 0 1 7.55 0Z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/>
    </svg>
  );
}