...
const useClustersData_1 = require("./useClustersData");
jest.mock('lib/api/useApiQuery');
const mockUseApiQuery = useApiQuery_1.default;
...
describe('useClustersData', () => {
    ...
    describe('input type detection logic', () => {
        it('should default to cluster_name when no search term provided', () => {
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('', 'leaderboard', 1));
        ...
        it('should call detectInputType when search term exists', () => {
            ...
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('0x123...', 'directory', 1));
        ...
        it('should memoize input type calculation', () => {
            ...
            const { rerender } = (0, react_1.renderHook)(({ searchTerm }) => (0, useClustersData_1.useClustersData)(searchTerm, 'directory', 1), { initialProps: { searchTerm: 'example.cluster' } });
    ...
    describe('view mode determination', () => {
        it('should show directory view when viewMode is directory', () => {
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('', 'directory', 1));
        ...
        it('should show directory view when search term exists regardless of viewMode', () => {
            mockDetectInputType.mockReturnValue('cluster_name');
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('search', 'leaderboard', 1));
            expect(mockUseApiQuery).toHaveBeenCalledWith('clusters:get_directory', expect.any(Object));
        });
    ...
    describe('API query configuration', () => {
        it('should configure leaderboard query with correct pagination', () => {
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('', 'leaderboard', 3));
            const leaderboardCall = mockUseApiQuery.mock.calls.find(call => call[0] === 'clusters:get_leaderboard');
        ...
        it('should configure directory query with search term', () => {
            mockDetectInputType.mockReturnValue('cluster_name');
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('example', 'directory', 2));
            const directoryCall = mockUseApiQuery.mock.calls.find(call => call[0] === 'clusters:get_directory');
        ...
        it('should configure address query when input type is address', () => {
            mockDetectInputType.mockReturnValue('address');
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('0x123...', 'directory', 1));
            const addressCall = mockUseApiQuery.mock.calls.find(call => call[0] === 'clusters:get_clusters_by_address');
        ...
        it('should call cluster details query when cluster ID is available', () => {
            ...
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('0x123...', 'directory', 1));
            const clusterDetailsCall = mockUseApiQuery.mock.calls.find(call => call[0] === 'clusters:get_cluster_by_id');
    ...
    describe('dynamic ordering business logic', () => {
        it('should use NAME_ASC ordering when search term exists', () => {
            mockDetectInputType.mockReturnValue('cluster_name');
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('search', 'directory', 1));
            const directoryCall = mockUseApiQuery.mock.calls.find(call => call[0] === 'clusters:get_directory');
        ...
        it('should memoize directory order by logic', () => {
            const { rerender } = (0, react_1.renderHook)(({ searchTerm }) => (0, useClustersData_1.useClustersData)(searchTerm, 'directory', 1), { initialProps: { searchTerm: 'search' } });
            jest.clearAllMocks();
    ...
    describe('query selection logic', () => {
        it('should return data from leaderboard query in leaderboard mode', () => {
            ...
            const { result } = (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('', 'leaderboard', 1));
        ...
        it('should return data from address query when input type is address', () => {
            ...
            const { result } = (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('0x123...', 'directory', 1));
        ...
        it('should return data from directory query when input type is cluster_name', () => {
            ...
            const { result } = (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('example', 'directory', 1));
    ...
    describe('pagination calculations', () => {
        ...
        it('should calculate correct offset for page 5', () => {
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('', 'leaderboard', 5));
            const leaderboardCall = mockUseApiQuery.mock.calls.find(call => call[0] === 'clusters:get_leaderboard');
    ...
    describe('query enabling/disabling logic', () => {
        ...
        it('should disable address query when input type is not address', () => {
            mockDetectInputType.mockReturnValue('cluster_name');
            (0, react_1.renderHook)(() => (0, useClustersData_1.useClustersData)('example', 'directory', 1));
            const addressCall = mockUseApiQuery.mock.calls.find(call => call[0] === 'clusters:get_clusters_by_address');
