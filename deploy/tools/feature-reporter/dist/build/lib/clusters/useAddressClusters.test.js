...
const useAddressClusters_1 = require("./useAddressClusters");
...
describe('useAddressClusters', () => {
    ...
    it('should call API with correct parameters', () => {
        ...
        (0, useAddressClusters_1.useAddressClusters)(addressHash);
    ...
    it('should be disabled when addressHash is empty', () => {
        (0, useAddressClusters_1.useAddressClusters)('');
        expect(mockUseApiQuery).toHaveBeenCalledWith('clusters:get_clusters_by_address', {
            queryParams: {
                input: JSON.stringify({
                    address: '',
    ...
    it('should handle isEnabled parameter', () => {
        const addressHash = '0x1234567890123456789012345678901234567890';
        (0, useAddressClusters_1.useAddressClusters)(addressHash, false);
        expect(mockUseApiQuery).toHaveBeenCalledWith('clusters:get_clusters_by_address', {
            queryParams: {
                input: JSON.stringify({
                    address: addressHash,
