...
exports.useRenderLine = useRenderLine;
const react_1 = require("@chakra-ui/react");
const d3 = __importStar(require("d3"));
const react_2 = __importDefault(require("react"));
const ChartTooltipLine = () => {
    const lineColor = (0, react_1.useToken)('colors', 'gray.400');
    return <line className="ChartTooltip__line" stroke={lineColor[0]} strokeDasharray="3"/>;
};
exports.default = react_2.default.memo(ChartTooltipLine);
function useRenderLine(ref, chartHeight) {
