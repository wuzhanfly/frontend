...
const OpSuperchainBlocks = () => {
  ...
  const tabs: Array<TabItemRegular> = [
    { id: 'blocks', title: t('validators.common.all'), component: <OpSuperchainBlocksContent type="block" query={ blocksQuery } chainSlug={ blocksQuery.chainValue?.[0] }/> },
    { id: 'reorgs', title: t('blocks.common.forked'), component: <OpSuperchainBlocksContent type="reorg" query={ reorgsQuery } chainSlug={ reorgsQuery.chainValue?.[0] }/> },
    { id: 'uncles', title: t('blocks.common.uncles'), component: <OpSuperchainBlocksContent type="uncle" query={ unclesQuery } chainSlug={ unclesQuery.chainValue?.[0] }/> },
  ];
