  ...
  return (
    <ListItemMobile rowGap={ 3 }>
      ...
      <HStack gap={ 3 } maxW="100%" alignItems="flex-start">
        <Skeleton loading={ isLoading } fontSize="sm" fontWeight={ 500 } flexShrink={ 0 }>{t('addresses_label_search.list_item.balance_ether', { currencyUnit: currencyUnits.ether })}</Skeleton>
