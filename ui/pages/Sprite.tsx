...
const Sprite = () => {
  ...
  const searchInput = <FilterInput placeholder={t('common.common.search_by_name')} onChange={ setSearchTerm } loading={ isFetching } minW={{ base: '100%', lg: '300px' }}/>;
  ...
  return (
    <div>
      <PageTitle title={t('common.common.svg_sprite_')} contentAfter={ contentAfter }/>
      { content }
    </div>
  );
};
