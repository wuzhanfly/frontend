...
# *****************************
FROM docker.m.daocloud.io/library/node:22.11.0-alpine AS deps
...
# ****** STAGE 2: Build *******
# *****************************
FROM docker.m.daocloud.io/library/node:22.11.0-alpine AS builder
...
FROM docker.m.daocloud.io/library/node:22.11.0-alpine AS runner
