...
// Import polyfills will be loaded in _app.tsx
...
const moduleExports = {
  ...
  webpack(config) {
    ...
    config.resolve.alias = {
      ...
      '@base-org/account': require.resolve('empty-npm-package'),
      '@gemini-wallet/core': require.resolve('empty-npm-package'),
      porto: require.resolve('empty-npm-package'),
      'porto/internal': require.resolve('empty-npm-package'),
    };
